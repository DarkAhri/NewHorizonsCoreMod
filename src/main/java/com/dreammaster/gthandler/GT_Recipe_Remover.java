...
public class GT_Recipe_Remover implements Runnable {
    ...
    public void run() {
        ...
        GT_ModHandler.removeRecipeByOutputDelayed(
                ...
                true);
        /*
         * GT_ModHandler.removeRecipeByOutputDelayed( getModItem(AppliedEnergistics2.ID, "tile.BlockCraftingUnit", 1,
         * 2), true, false, true); GT_ModHandler.removeRecipeByOutputDelayed( getModItem(AppliedEnergistics2.ID,
         * "tile.BlockCraftingUnit", 1, 3), true, false, true); GT_ModHandler.removeRecipeByOutputDelayed(
         * getModItem(AppliedEnergistics2.ID, "item.ItemMultiPart", 1, 556), true, false, true);
         * GT_ModHandler.removeRecipeByOutputDelayed( getModItem(AppliedEnergistics2.ID, "item.ItemMultiPart", 1, 56),
         * true, false, true); GT_ModHandler.removeRecipeByOutputDelayed( getModItem(AppliedEnergistics2.ID,
         * "item.ItemMultiPart", 1, 76), true, false, true); GT_ModHandler.removeRecipeByOutputDelayed(
         * getModItem(AppliedEnergistics2.ID, "item.ItemMultiPart", 1, 576), true, false, true);
         */
        // ASP
        GT_ModHandler.removeRecipeByOutputDelayed(

...
public class RecipeRemover {
    ...
    public static void run() {
         ...
         * removeRecipeByOutputDelayed( getModItem("appliedenergistics2", "tile.BlockQuartzGrowthAccelerator", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockCraftingUnit", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockCraftingUnit", 1, 1,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockMolecularAssembler", 1,
         * 0, missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockCharger", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockInscriber", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockQuantumRing", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockQuantumLinkChamber", 1,
         * 0, missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockSpatialPylon", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockSpatialIOPort", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockInterface", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockCellWorkbench", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "tile.BlockIOPort", 1, 0, missing));
         ...
         * removeRecipeByOutputDelayed( getModItem("appliedenergistics2", "item.ToolCertusQuartzCuttingKnife", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolCertusQuartzWrench", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolMassCannon", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolMemoryCard", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolChargedStaff", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolEntropyManipulator", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolColorApplicator", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ToolBiometricCard", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ItemCrystalSeed", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ItemCrystalSeed", 1, 600,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ItemCrystalSeed", 1, 1200,
         * missing)); removeRecipeByOutputDelayed( getModItem("appliedenergistics2",
         * "item.ToolNetherQuartzCuttingKnife", 1, 0, missing));
         ...
         * removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ItemBasicStorageCell.1k", 1, 0,
         * missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ItemBasicStorageCell.4k", 1,
         * 0, missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2", "item.ItemBasicStorageCell.16k",
         * 1, 0, missing)); removeRecipeByOutputDelayed(getModItem("appliedenergistics2",
         * "item.ItemBasicStorageCell.64k", 1, 0, missing));
         ...
         * removeRecipeByOutputDelayed( getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.2Cubed", 1, 0,
         * missing)); removeRecipeByOutputDelayed( getModItem("appliedenergistics2",
         * "item.ItemSpatialStorageCell.16Cubed", 1, 0, missing)); removeRecipeByOutputDelayed(
         ...
         * removeRecipeByOutputDelayed( getModItem("thaumicenergistics",
         * "thaumicenergistics.block.essentia.cell.workbench", 1, 0, missing));
         */
        ...
        removeRecipeShapedDelayed(
                ...
                new Object[] { getModItem("ForbiddenMagic", "FMResource", 1, 0, missing),
                        ...
                        getModItem("ForbiddenMagic", "FMResource", 1, 0, missing) });
        /*
         * removeRecipeShapedDelayed( getModItem("minecraft", "diamond", 1, 0, missing), new Object[] {
         * getModItem("MagicBees", "beeNugget", 1, 5, missing), getModItem("MagicBees", "beeNugget", 1, 5, missing),
         * getModItem("MagicBees", "beeNugget", 1, 5, missing) }, new Object[] { getModItem("MagicBees", "beeNugget", 1,
         * 5, missing), getModItem("MagicBees", "beeNugget", 1, 5, missing), getModItem("MagicBees", "beeNugget", 1, 5,
         * missing) }, new Object[] { getModItem("MagicBees", "beeNugget", 1, 5, missing), getModItem("MagicBees",
         * "beeNugget", 1, 5, missing), getModItem("MagicBees", "beeNugget", 1, 5, missing) });
         */
        removeRecipeShapedDelayed(
